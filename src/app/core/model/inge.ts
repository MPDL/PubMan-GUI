...
export interface User extends BasicRO {
  loginname: string;
  password: string;
  email: string;
  affiliation: BasicRO;
...
export interface Ou extends BasicRO {
...
export interface Ctx extends BasicRO {
  state: string;
  description: string;
  responsibleAffiliations: BasicRO[];
  allowedGenres: string[];
  allowedSubjectinterfaceifications: string[];
  workflow: string;
  contactEmail: string;
}
